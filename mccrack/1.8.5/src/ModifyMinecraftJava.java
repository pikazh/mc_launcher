...
public class ModifyMinecraftJava {
    public static void main(String[] args) {
        ...
        try{
            ...
            while(enu.hasMoreElements()){
                ...
                if(name.compareTo("ave.class") == 0){
                    obj.modifyMinecraftClass("ave.class", jarFile.getInputStream(entry));
                }
                else if(name.compareTo("bcy.class") == 0){
                    obj.modifyNetHandlerClass("bcy.class", jarFile.getInputStream(entry));
                }
            }
    ...
    class NetHandlerTransform extends ClassVisitor {
        ...
        public MethodVisitor visitMethod(int var1, String var2, String var3, String var4, String[] var5) {
            if (var2.compareTo("a") == 0 && var3.compareTo("(Lgt;)V") == 0)
    ...
    class handleJoinGameMethodVisitor extends MethodVisitor{
        ...
        public void visitInsn(int var1) {
            if(Opcodes.RETURN == var1){
                ...
                visitFieldInsn(Opcodes.GETFIELD, "bcy", "f", "Lave;");
                visitFieldInsn(Opcodes.GETFIELD, "ave", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
    ...
    class MinecraftClassTransform extends ClassVisitor{
        ...
        public MethodVisitor visitMethod(int var1, String var2, String var3, String var4, String[] var5) {
            ...
            else if(var2.compareTo("a")== 0 && var3.compareTo("(Lbdb;)V") == 0)
    ...
    class MainMethodVisitor extends MethodVisitor {
        ...
        public void visitInsn(int var1) {
            if (Opcodes.RETURN == var1) {
                ...
                visitVarInsn(Opcodes.ALOAD, 0);
                visitMethodInsn(Opcodes.INVOKESPECIAL, Type.getInternalName(CraftBoxHelper.class), "<init>", "(Lave;)V", false);
                visitFieldInsn(Opcodes.PUTFIELD, "ave", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
            }
            super.visitInsn(var1);
        }
    }
