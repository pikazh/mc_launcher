...
public class ModifyMinecraftJava {
    public static void main(String[] args) {
        ...
        try{
            ...
            while(enu.hasMoreElements()){
                ...
                if(name.compareTo("bcd.class") == 0){
                    obj.modifyMinecraftClass("bcd.class", jarFile.getInputStream(entry));
                }
                else if(name.compareTo("bkq.class") == 0){
                    obj.modifyNetHandlerClass("bkq.class", jarFile.getInputStream(entry));
                }
            }
    ...
    class NetHandlerTransform extends ClassVisitor {
        ...
        public MethodVisitor visitMethod(int var1, String var2, String var3, String var4, String[] var5) {
            if (var2.compareTo("a") == 0 && var3.compareTo("(Lgu;)V") == 0)
    ...
    class handleJoinGameMethodVisitor extends MethodVisitor{
        ...
        public void visitInsn(int var1) {
            if(Opcodes.RETURN == var1){
                ...
                visitFieldInsn(Opcodes.GETFIELD, "bkq", "f", "Lbcd;");
                visitFieldInsn(Opcodes.GETFIELD, "bcd", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
    ...
    class MinecraftClassTransform extends ClassVisitor{
        ...
        public MethodVisitor visitMethod(int var1, String var2, String var3, String var4, String[] var5) {
            ...
            else if(var2.compareTo("a")== 0 && var3.compareTo("(Lbks;)V") == 0)
    ...
    class MainMethodVisitor extends MethodVisitor {
        ...
        public void visitInsn(int var1) {
            if (Opcodes.RETURN == var1) {
                ...
                visitVarInsn(Opcodes.ALOAD, 0);
                visitMethodInsn(Opcodes.INVOKESPECIAL, Type.getInternalName(CraftBoxHelper.class), "<init>", "(Lbcd;)V", false);
                visitFieldInsn(Opcodes.PUTFIELD, "bcd", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
            }
            super.visitInsn(var1);
        }
    }
