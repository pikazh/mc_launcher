...
public class ModifyMinecraftJava {
    public static void main(String[] args) {
        ...
        try{
            ...
            while(enu.hasMoreElements()){
                ...
                if(name.compareTo("azd.class") == 0){
                    obj.modifyMinecraftClass("azd.class", jarFile.getInputStream(entry));
                }
                else if(name.compareTo("biv.class") == 0){
                    obj.modifyNetHandlerClass("biv.class", jarFile.getInputStream(entry));
                }
            }
    ...
    class handleJoinGameMethodVisitor extends MethodVisitor{
        ...
        public void visitInsn(int var1) {
            if(Opcodes.RETURN == var1){
                ...
                visitFieldInsn(Opcodes.GETFIELD, "biv", "f", "Lazd;");
                visitFieldInsn(Opcodes.GETFIELD, "azd", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
    ...
    class MinecraftClassTransform extends ClassVisitor{
        ...
        public MethodVisitor visitMethod(int var1, String var2, String var3, String var4, String[] var5) {
            ...
            else if(var2.compareTo("a")== 0 && var3.compareTo("(Lbiz;)V") == 0)
    ...
    class MainMethodVisitor extends MethodVisitor {
        ...
        public void visitInsn(int var1) {
            if (Opcodes.RETURN == var1) {
                ...
                visitVarInsn(Opcodes.ALOAD, 0);
                visitMethodInsn(Opcodes.INVOKESPECIAL, Type.getInternalName(CraftBoxHelper.class), "<init>", "(Lazd;)V", false);
                visitFieldInsn(Opcodes.PUTFIELD, "azd", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
            }
            super.visitInsn(var1);
        }
    }
