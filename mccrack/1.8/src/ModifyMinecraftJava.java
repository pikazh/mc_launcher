...
public class ModifyMinecraftJava {
    public static void main(String[] args) {
        ...
        try{
            ...
            while(enu.hasMoreElements()){
                ...
                if(name.compareTo("bsu.class") == 0){
                    obj.modifyMinecraftClass("bsu.class", jarFile.getInputStream(entry));
                }
                else if(name.compareTo("cee.class") == 0){
                    obj.modifyNetHandlerClass("cee.class", jarFile.getInputStream(entry));
                }
            }
    ...
    class NetHandlerTransform extends ClassVisitor {
        ...
        public MethodVisitor visitMethod(int var1, String var2, String var3, String var4, String[] var5) {
            if (var2.compareTo("a") == 0 && var3.compareTo("(Ljw;)V") == 0)
    ...
    class handleJoinGameMethodVisitor extends MethodVisitor{
        ...
        public void visitInsn(int var1) {
            if(Opcodes.RETURN == var1){
                ...
                visitFieldInsn(Opcodes.GETFIELD, "cee", "f", "Lbsu;");
                visitFieldInsn(Opcodes.GETFIELD, "bsu", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
    ...
    class MinecraftClassTransform extends ClassVisitor{
        ...
        public MethodVisitor visitMethod(int var1, String var2, String var3, String var4, String[] var5) {
            ...
            else if(var2.compareTo("a")== 0 && var3.compareTo("(Lcen;)V") == 0)
    ...
    class MainMethodVisitor extends MethodVisitor {
        ...
        public void visitInsn(int var1) {
            if (Opcodes.RETURN == var1) {
                ...
                visitVarInsn(Opcodes.ALOAD, 0);
                visitMethodInsn(Opcodes.INVOKESPECIAL, Type.getInternalName(CraftBoxHelper.class), "<init>", "(Lbsu;)V", false);
                visitFieldInsn(Opcodes.PUTFIELD, "bsu", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
            }
            super.visitInsn(var1);
        }
    }
