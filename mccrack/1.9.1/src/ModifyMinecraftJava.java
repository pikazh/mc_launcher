...
public class ModifyMinecraftJava {
    public static void main(String[] args) {
        ...
        try{
            ...
            while(enu.hasMoreElements()){
                ...
                if(name.compareTo("bcc.class") == 0){
                    obj.modifyMinecraftClass("bcc.class", jarFile.getInputStream(entry));
                }
                else if(name.compareTo("bkp.class") == 0){
                    obj.modifyNetHandlerClass("bkp.class", jarFile.getInputStream(entry));
                }
            }
    ...
    class handleJoinGameMethodVisitor extends MethodVisitor{
        ...
        public void visitInsn(int var1) {
            if(Opcodes.RETURN == var1){
                ...
                visitFieldInsn(Opcodes.GETFIELD, "bkp", "f", "Lbcc;");
                visitFieldInsn(Opcodes.GETFIELD, "bcc", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
    ...
    class MinecraftClassTransform extends ClassVisitor{
        ...
        public MethodVisitor visitMethod(int var1, String var2, String var3, String var4, String[] var5) {
            ...
            else if(var2.compareTo("a")== 0 && var3.compareTo("(Lbkr;)V") == 0)
    ...
    class MainMethodVisitor extends MethodVisitor {
        ...
        public void visitInsn(int var1) {
            if (Opcodes.RETURN == var1) {
                ...
                visitVarInsn(Opcodes.ALOAD, 0);
                visitMethodInsn(Opcodes.INVOKESPECIAL, Type.getInternalName(CraftBoxHelper.class), "<init>", "(Lbcc;)V", false);
                visitFieldInsn(Opcodes.PUTFIELD, "bcc", "craftBoxHelper", Type.getDescriptor(CraftBoxHelper.class));
            }
            super.visitInsn(var1);
        }
    }
