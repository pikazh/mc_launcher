...
namespace sigslot {
	...
	template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
		class arg5_type, class arg6_type, class arg7_type, class arg8_type, class arg9_type, class mt_policy>
		class _connection_base9
	{
	public:
		virtual ~_connection_base9() {}
		virtual has_slots_interface* getdest() const = 0;
		virtual void emit(arg1_type, arg2_type, arg3_type, arg4_type, arg5_type,
			arg6_type, arg7_type, arg8_type, arg9_type) = 0;
		virtual _connection_base9<arg1_type, arg2_type, arg3_type, arg4_type,
			arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>* clone() = 0;
		virtual _connection_base9<arg1_type, arg2_type, arg3_type, arg4_type,
			arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>* duplicate(has_slots_interface* pnewdest) = 0;
	};
	...
	template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
		class arg5_type, class arg6_type, class arg7_type, class arg8_type, class arg9_type, class mt_policy>
		class _signal_base9 : public _signal_base<mt_policy>
	{
	public:
		typedef std::list<_connection_base9<arg1_type, arg2_type, arg3_type,
			arg4_type, arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy> *>
			connections_list;
		...
		_signal_base9(const _signal_base9<arg1_type, arg2_type, arg3_type, arg4_type,
			arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>& s)
			: _signal_base<mt_policy>(s)
		{
			lock_block<mt_policy> lock(this);
			typename connections_list::const_iterator it = s.m_connected_slots.begin();
	...
	template<class dest_type, class mt_policy>
	class _functor_connection0 : public _connection_base0<mt_policy>
	{
	public:
		_functor_connection0()
		{
			m_pobject = NULL;
		}

		_functor_connection0(dest_type* pobject, const std::function<void()> &functor)
		{
			m_pobject = pobject;
			m_functor = functor;
		}

		_functor_connection0(dest_type* pobject, std::function<void()> &&functor)
		{
			m_pobject = pobject;
			m_functor = functor;
		}

		virtual ~_functor_connection0()
		{
		}

		virtual _connection_base0<mt_policy>* clone()
		{
			return new _functor_connection0<dest_type, mt_policy>(*this);
		}

		virtual _connection_base0<mt_policy>* duplicate(has_slots_interface* pnewdest)
		{
			return new _functor_connection0<dest_type, mt_policy>((dest_type *)pnewdest, m_functor);
		}
	...
	template<class dest_type, class arg1_type, class mt_policy>
	class _functor_connection1 : public _connection_base1<arg1_type, mt_policy>
	{
	public:
		_functor_connection1()
		{
			m_pobject = NULL;
		}

		_functor_connection1(dest_type* pobject, std::function<void(arg1_type)> &&functor)
		{
			m_pobject = pobject;
			m_functor = functor;
		}

		_functor_connection1(dest_type* pobject, const std::function<void(arg1_type)> &functor)
		{
			m_pobject = pobject;
			m_functor = functor;
		}

		virtual ~_functor_connection1()
		{
		}

		virtual _connection_base1<arg1_type, mt_policy>* clone()
		{
			return new _functor_connection1<dest_type, arg1_type, mt_policy>(*this);
		}

		virtual _connection_base1<arg1_type, mt_policy>* duplicate(has_slots_interface* pnewdest)
		{
			return new _functor_connection1<dest_type, arg1_type, mt_policy>((dest_type *)pnewdest, m_functor);
		}
	...
	private:
		dest_type* m_pobject;
		std::function<void(arg1_type)> m_functor;
	};
	...
	template<class dest_type, class arg1_type, class arg2_type, class arg3_type,
		class arg4_type, class arg5_type, class arg6_type, class arg7_type,
		class arg8_type, class arg9_type, class mt_policy>
		class _connection9 : public _connection_base9<arg1_type, arg2_type,
		arg3_type, arg4_type, arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>
	{
	public:
		_connection9()
		{
		...
		_connection9(dest_type* pobject, void (dest_type::*pmemfun)(arg1_type,
			arg2_type, arg3_type, arg4_type, arg5_type, arg6_type,
		...
		virtual ~_connection9()
		{
		}

		virtual _connection_base9<arg1_type, arg2_type, arg3_type, arg4_type,
			arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>* clone()
		{
			return new _connection9<dest_type, arg1_type, arg2_type, arg3_type, arg4_type,
				arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>(*this);
		}

		virtual _connection_base9<arg1_type, arg2_type, arg3_type, arg4_type,
			arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>* duplicate(has_slots_interface* pnewdest)
		{
			return new _connection9<dest_type, arg1_type, arg2_type, arg3_type, arg4_type,
				arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>((dest_type *)pnewdest, m_pmemfun);
		}

		virtual void emit(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4,
			arg5_type a5, arg6_type a6, arg7_type a7, arg8_type a8, arg9_type a9)
		{
			(m_pobject->*m_pmemfun)(a1, a2, a3, a4, a5, a6, a7, a8, a9);
		}
	...
	public:
		...
		template<class desttype>
			void connect(desttype* pclass, std::function<void()> functor)
		{
			lock_block<mt_policy> lock(this);
			_functor_connection0<desttype, mt_policy>* conn =
				new _functor_connection0<desttype, mt_policy>(pclass, std::move(functor));
			m_connected_slots.push_back(conn);
			pclass->signal_connect(this);
		}
	...
	public:
		...
		template<class desttype>
			void connect(desttype* pclass, std::function<void(arg1_type)> functor)
		{
			lock_block<mt_policy> lock(this);
			_functor_connection1<desttype, arg1_type, mt_policy>* conn =
				new _functor_connection1<desttype, arg1_type, mt_policy>(pclass, std::move(functor));
			m_connected_slots.push_back(conn);
			pclass->signal_connect(this);
		}
	...
	template<class arg1_type, class arg2_type, class arg3_type, class arg4_type,
		class arg5_type, class arg6_type, class arg7_type, class arg8_type, class arg9_type, class mt_policy = SIGSLOT_DEFAULT_MT_POLICY>
		class signal9 : public _signal_base9<arg1_type, arg2_type, arg3_type,
		arg4_type, arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>
	{
	public:
		typedef _signal_base9<arg1_type, arg2_type, arg3_type, arg4_type,
			arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy> base;
		typedef typename base::connections_list connections_list;
		using base::m_connected_slots;
		...
		signal9(const signal9<arg1_type, arg2_type, arg3_type, arg4_type,
			arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>& s)
			: _signal_base9<arg1_type, arg2_type, arg3_type, arg4_type,
			arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>(s)
		{
			;
		}
		...
		{
			lock_block<mt_policy> lock(this);
			_connection9<desttype, arg1_type, arg2_type, arg3_type, arg4_type,
				arg5_type, arg6_type, arg7_type, arg8_type, arg9_type, mt_policy>* conn =
				new _connection9<desttype, arg1_type, arg2_type, arg3_type,
				arg4_type, arg5_type, arg6_type, arg7_type,
				arg8_type, arg9_type, mt_policy>(pclass, pmemfun);
			m_connected_slots.push_back(conn);
			pclass->signal_connect(this);
		}
			...
			arg5_type a5, arg6_type a6, arg7_type a7, arg8_type a8, arg9_type a9)
		{
			...
			while (it != itEnd)
			{
				...
				(*it)->emit(a1, a2, a3, a4, a5, a6, a7, a8, a9);
